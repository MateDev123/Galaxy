const ava = ({ icon = 'success', toast = false, progressBar = true, text = null, timer = 4000, btnText = 'Okay', direction = 'rtl', position = 'top-right' }) => {
    ...
    if (icon == 'success' && toast == false) {
      ...
      `;
        ...
        avaIcon = `
            <div class="ava-alert__icon" style="background: #003CC5;">
        ...
        avaIcon = `
            <div class="ava-alert__icon" style="background: rgb(40, 130, 111);">
        ...
        avaIcon = `
            <div class="ava-alert__icon" style="background: #DC2537;">
...
function Toast_info() {
    ava({
        icon: 'info',
        text: 'Ez a funkcó még nem elérhető!',
        btnText: '',
        progressBar: true,
        toast: true,
        position: 'top-right',
...
jQuery(document).ready(function($) {
    function Toast_white() {
        ava({
            icon: 'none',
            text: 'Üdvözöllek a Galaxy weboldalán!',
            btnText: '',
            progressBar: true,
            toast: true,
            position: 'top-right',
